...
export const useResumestore = defineStore('resume', () => {
  const defaultData = {
    ...
    skills: [{ name: 'JavaScript', icon: 'i-vscode-icons-file-type-js-official' }, { name: 'TypeScript', icon: 'i-vscode-icons-file-type-typescript-official' }, { name: 'React/Next.js/Remix', icon: 'i-vscode-icons-file-type-reactjs' }, { name: 'Node.js', icon: 'i-vscode-icons-file-type-node' }, { name: 'GraphQL', icon: 'i-vscode-icons-file-type-graphql' }, { name: 'Relay', icon: 'i-vscode-icons-folder-type-library' }, { name: 'WebRTC', icon: '' }, { name: 'Docker', icon: 'i-vscode-icons-file-type-docker2' }, { name: 'Kubernetes', icon: 'i-vscode-icons-folder-type-kubernetes' }, { name: 'MongoDB', icon: 'i-vscode-icons-folder-type-mongodb-opened' }, { name: 'MySQL', icon: 'i-vscode-icons-file-type-mysql' }, { name: 'Redis', icon: 'i-vscode-icons-folder-type-redis' }, { name: 'Nginx', icon: 'i-vscode-icons-file-type-nginx' }, { name: 'AWS', icon: 'i-vscode-icons-folder-type-aws' }, { name: 'GCP', icon: 'i-vscode-icons-folder-type-gcp' }, { name: 'Azure', icon: 'i-vscode-icons-folder-type-azure' }, { name: 'Git', icon: 'i-vscode-icons-folder-type-git' }, { name: 'GitHub', icon: 'i-vscode-icons-folder-type-github' }, { name: 'GitLab', icon: 'i-vscode-icons-folder-type-gitlab' }, { name: 'Vue', icon: 'i-vscode-icons-file-type-vue' }, { name: 'Nuxt', icon: 'i-vscode-icons-file-type-nuxt' }],
    education: [
      {
